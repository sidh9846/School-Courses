...
class BST:
    ...
    def __contains__(self, key):
        ...
        while current is not None and not contains:
    ...
    def _parent_r_aux(self, node, key, prev_value):
        ...
        if node._value == key:
            return prev_value
        if node._value > key:
            return self._parent_r_aux(node._left, key, node._value)
        else:
            return self._parent_r_aux(node._right, key, node._value)
