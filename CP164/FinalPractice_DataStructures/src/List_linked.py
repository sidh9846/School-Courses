...
class List:
    ...
    def clean(self):
        ...
        while curr is not None:
            if curr._value in dups:
                prev, curr, index = self._linear_search(curr._value)
    ...
    def __eq__(self, target):
        ...
        while curr is not None and equals:
            if curr._value != tar_curr._value:
                equals = False
            else:
                curr = curr._next
    ...
    def intersection(self, source1, source2):
        ...
        while curr1 is not None:
            if curr1._value not in self and curr1._value in source2:
                self.append(curr1._value)

            curr1 = curr1._next

        while curr2 is not None:
            if curr2._value not in self and curr2._value in source1:
                self.append(curr2._value)
    ...
    def union(self, source1, source2):
        ...
        while curr1 is not None:
            if curr1._value not in self:
                self.append(curr1._value)

            curr1 = curr1._next

        while curr2 is not None:
            if curr2._value not in self:
                self.append(curr2._value)
    ...
    def copy(self):
        ...
        while curr is not None:
            new_list.append(deepcopy(curr._value))
            curr = curr._next
    ...
    def _move_front_to_front(self, source):
        ...
        if self._count == 0:
            ...
            self._front, self._front._next, source._front, source._front._next = source._front, source._front._next, self._front, self._front._next
