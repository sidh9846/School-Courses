	...
	public String toString() {
		...
		StringBuilder receipt = new StringBuilder("Receipt\n");
		 ...
		 for (Map.Entry<MenuItem, Integer> entry : orderItems.entrySet()) {
	            ...
	            receipt.append(String.format("%-20s%3d @ $%6.2f = $%8.2f%n",
	                    item.getName(), quantity, item.getPrice(), itemTotal));
	        }

	        receipt.append(String.format("%nSubtotal:%25s$%8.2f%n", "", getSubTotal()));
	        receipt.append(String.format("Taxes:%28s$%8.2f%n", "", getTaxes()));
	        receipt.append(String.format("Total:%28s$%8.2f%n", "", getTotal()));
