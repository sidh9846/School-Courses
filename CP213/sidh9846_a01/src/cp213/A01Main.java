...
public class A01Main {
	...
	Object[][] testData = { { "a", true }, { "_a", true }, { "1a", false }, { "_", false } };
	...
	Object[][] testData = { { 7, true }, { 5, true }, { 9, false } , { 1, false } };
	...
	Object[][] testData = { { "ABC", 0, "ABC" }, { "ABC", 3, "DEF" }, { "ABC", 30, "EFG" }, { "A!BC", 30, "E!FG" } };
	...
	Object[][] testData = { { "AB!C", "AV!I" }, { "XY?4Z", "XY?4D" } };
