...
public class InnerClassPanel extends JPanel {
			...
			if (e.getSource() == mustard) {
				if (e.getStateChange() == 1) {
					...
					System.out.println("Mustard Selected");
			 		...
			 		System.out.println("Mustard Deselected");
			 	}
				...
				if (e.getStateChange() == 1) {
					...
					System.out.println("Onions Selected");
			 		...
			 		System.out.println("Onions Deselected");
			 	}
			} 
			else if (e.getSource() == ketchup) {
				if (e.getStateChange() == 1) {
					checkBoxesSelected.add("Ketchup");
					System.out.println("Ketchup Selected");
			 	} else {
			 		checkBoxesSelected.remove("Ketchup");
			 		System.out.println("Ketchup Deselected");
			 	} 
			} else {
	...
	private class RadioButtonListener implements ActionListener {
		...
		public void actionPerformed(final ActionEvent e) {
			...
			if (starTrek.isSelected()) {
				radioButtonSet = "Star Trek";
				System.out.println("Star Trek Selected");
			} else if (starWars.isSelected()) {
				radioButtonSet = "Star Wars";
